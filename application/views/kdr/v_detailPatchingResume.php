	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Detail Patching Resume</li>
			</ul>
		</div>
			...
			<div class="row">
				...
				<div class="infobox infobox-black">
					...
					<div class="infobox-data">
						...
						<div class="infobox-content"><a href="<?php echo base_url('kdr/patching_resume/download_detail_resume/'.$tanggal_start.'/'.$tanggal_end.'/'.$jenis_patching);?>">Download</a></div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="table-header">
						Patching Resume <?php echo $jenis_patching;?> <?php echo $filter;?>
					</div>
...
<div class="modal fade" id="justify<?php echo $id_patching;?>" tabindex="-1" role="dialog" aria-labelledby="justify" aria-hidden="true">
    <div class="modal-dialog" style="width:700px;">
	    <div class="modal-content">
		    ...
		    <form class="form-horizontal" action="<?php echo base_url().'kdr/patching_resume/update_justifikasi'?>" method="post">
		        <div class="modal-body">
                    ...
                    <input type="hidden" name="jenis_patching" value="<?php echo $jenis_patching;?>">
		        </div>
		        <div class="modal-footer">
		            ...
		            <?php if($justifikasi == "1") { ?>
		            	<button type="button" onclick="window.location='<?php echo base_url("kdr/patching_resume/batal_justifikasi/".$id_patching.'/'.$tanggal_start.'/'.$tanggal_end.'/'.$jenis_patching);?>'" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-ban" aria-hidden="true"></i>&nbsp;&nbsp;Batalkan Justifikasi</button>
		            <?php } ?>
		        </div>
	    	</form>
	    </div>
