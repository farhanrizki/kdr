<?php
	...
	header("content-disposition: attachment;filename=detail_patching_divisi_".date('d-m-Y').".xls");
	...
	" 
		<table>
			<tr>
				<td>&nbsp;</td>
				<td style='border-style:none;font-weight: bold;'>Detail Patching ".$nama_divisi." ".$tanggal."</td>
			</tr>
		</table>
