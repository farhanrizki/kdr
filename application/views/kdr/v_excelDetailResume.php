<?php
	...
	header("content-disposition: attachment;filename=detail_patching_resume_".date('d-m-Y').".xls");
	...
	" 
		<table>
			<tr>
				<td>&nbsp;</td>
				<td style='border-style:none;font-weight: bold;'>Detail Patching Resume ".$jenis_patching." ".$tanggal."</td>
			</tr>
		</table>
