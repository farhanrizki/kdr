	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li>
					<a href="<?php echo base_url('kdr/patching_divisi'); ?>">Patching Divisi</a>
				</li>
				<li class="active">Detail Patching Divisi</li>
			</ul>
		</div>
			...
			<div class="row">
				<div class="col-xs-3">
					<div class="infobox infobox-black">
						...
						<div class="infobox-data">
							...
							<div class="infobox-content"><a href="<?php echo base_url('kdr/patching_divisi/download_detail_divisi/'.$tanggal_start.'/'.$tanggal_end.'/'.$nama_divisi);?>">Download</a></div>
						</div>
					</div>
				</div>
				...
				<div class="col-xs-3">
					<div class="infobox infobox-black">
						...
						<div class="infobox-data">
							<div class="infobox-content">Download BA</div>
							<div class="infobox-content"><a href="<?php echo base_url('kdr/patching_divisi/download_ba/'.$tanggal_start.'/'.$tanggal_end.'/'.$nama_divisi);?>">Download</a></div>
						</div>
					</div>
				</div>
				...
				<?php if($tanggal_start == 0){ } else { ?>
					<div style="float: right; margin-right: 12px; margin-top: 10px;">
						<form method="post" action="<?php echo base_url('kdr/patching_divisi/filter_divisi'); ?>">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="table-header">
						Patching <?php echo $nama_divisi;?> <?php echo $filter;?>
					</div>
...
<div class="modal fade" id="justify<?php echo $id_patching;?>" tabindex="-1" role="dialog" aria-labelledby="justify" aria-hidden="true">
    <div class="modal-dialog" style="width:700px;">
	    <div class="modal-content">
		    ...
		    <form class="form-horizontal" action="<?php echo base_url().'kdr/patching_divisi/update_justifikasi'?>" method="post">
		        ...
		        <div class="modal-footer">
		            ...
		            <?php if($justifikasi == "1") { ?>
		            	<button type="button" onclick="window.location='<?php echo base_url("kdr/patching_divisi/batal_justifikasi/".$id_patching.'/'.$tanggal_start.'/'.$tanggal_end.'/'.$nama_divisi);?>'" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-ban" aria-hidden="true"></i>&nbsp;&nbsp;Batalkan Justifikasi</button>
		            <?php } ?>
		        </div>
	    	</form>
	    </div>
