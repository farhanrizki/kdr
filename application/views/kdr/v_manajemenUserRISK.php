	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Manajemen User RISK</li>
			</ul>
		</div>
	            ...
	            <div class="col-xs-12">
	                <div class="box box-primary">
	                    ...
	                    <div class="box-header">
	                        <h4 class="box-title">Daftar User RISK Aktif</h4>
	                    </div>
	                    ...
	                    <div class="box-body">
	                        <table id="tabel" class="table table-bordered table-striped" style="font-size: 11pt">
                                ...
                                <?php 
									$no = 1;
									foreach($user_risk_aktif as $row)
									{
								?>
										<tr>
											<td><?=$no++?>.</td>
	                    ...
	                    <div class="box-header">
	                        <h4 class="box-title">Daftar User RISK Non Aktif</h4>
	                    </div>
	                    ...
	                    <div class="box-body">
	                        <table id="tabel2" class="table table-bordered table-striped" style="font-size: 11pt">
                                ...
                                <?php 
									$no = 1;
									foreach($user_risk_nonaktif as $row)
									{
								?>
										<tr>
											<td><?=$no++?>.</td>
    ...
    <div class="modal-dialog" style="width:750px;">
	    <div class="modal-content">
		    <div class="modal-header">
                ...
                <h4 class="modal-title">Edit User RISK Aktif</h4>
		    </div>
		    <form class="form-horizontal" action="<?php echo base_url().'kdr/manajemen_user_risk'?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="untuk_web[<?=$row['id_user']?>]" id="untuk_web" class="chosen-select form-control" id="form-field-select-3" required>
                            	...
                            	<option value="risk" <?php if($untuk_web == "risk"){ echo 'selected';} ?>>RISK</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog">
	    <div class="modal-content">
		    <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Konfirmasi Hapus Data User RISK Aktif</h4>
		    </div>
		    <div class="modal-body">
		    	<form class="form-horizontal" action="<?php echo base_url().'kdr/manajemen_user_risk'?>" method="post">
			        <div class="modal-body">
    ...
    <div class="modal-dialog" style="width:750px;">
	    <div class="modal-content">
		    <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Edit User RISK Non Aktif</h4>
		    </div>
		    <form class="form-horizontal" action="<?php echo base_url().'kdr/manajemen_user_risk'?>" method="post">
		        <div class="modal-body">
		            <div class="form-group">
    ...
    <div class="modal-dialog">
	    <div class="modal-content">
		    <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Konfirmasi Hapus Data User RISK Non Aktif</h4>
		    </div>
		    <div class="modal-body">
		    	<form class="form-horizontal" action="<?php echo base_url().'kdr/manajemen_user_risk'?>" method="post">
			        <div class="modal-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Tambahkan User RISK Baru</h4>
            </div>
            <form class="form-horizontal" action="<?php echo base_url('kdr/manajemen_user_risk'); ?>" method="post">
                <div class="modal-body">
                	<div class="form-group">
