<?php
	...
	header("content-disposition: attachment;filename=resume_bulan_".strtolower($nama_bulan)."_tahun_".$tahun_filter.".xls");
	...
	" 
		<table>
			<tr>
				<td>&nbsp;</td>
				<td style='border-style:none;font-weight: bold;'>Detail Patching Resume ".$nama_bulan." ".$tahun_filter."</td>
			</tr>
		</table>
