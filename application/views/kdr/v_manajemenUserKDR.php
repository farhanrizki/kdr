	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Manajemen User KDR</li>
			</ul>
		</div>
	            ...
	            <div class="col-xs-12">
	                <div class="box box-primary">
	                    ...
	                    <div class="box-header">
	                        <h4 class="box-title">Daftar User KDR Aktif</h4>
	                    </div>
	                    ...
	                    <div class="box-header">
	                        <h4 class="box-title">Daftar User KDR Non Aktif</h4>
	                    </div>
	                    ...
	                    <div class="box-body">
	                        <table id="tabel2" class="table table-bordered table-striped" style="font-size: 11pt">
                                ...
                                <?php 
									$no = 1;
									foreach($user_kdr_nonaktif as $row)
									{
								?>
										<tr>
											<td><?=$no++?>.</td>
    ...
    <div class="modal-dialog" style="width:750px;">
	    <div class="modal-content">
		    <div class="modal-header">
                ...
                <h4 class="modal-title">Edit User KDR Aktif</h4>
		    </div>
		    <form class="form-horizontal" action="<?php echo base_url().'kdr/manajemen_user_kdr'?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="level[<?=$row['id_user']?>]" id="level" class="chosen-select form-control" id="form-field-select-3" required>
                            	...
                            	<option value="kabagkdr" <?php if($level == 'kabagkdr'){ echo 'selected';} ?>>Kabag KDR</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="untuk_web[<?=$row['id_user']?>]" id="untuk_web" class="chosen-select form-control" id="form-field-select-3" required>
                            	...
                            	<option value="kdr" <?php if($untuk_web == "kdr"){ echo 'selected';} ?>>KDR</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog">
	    <div class="modal-content">
		    <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Konfirmasi Hapus Data User KDR Aktif</h4>
		    </div>
		    <div class="modal-body">
		    	<form class="form-horizontal" action="<?php echo base_url().'kdr/manajemen_user_kdr'?>" method="post">
			        <div class="modal-body">
    ...
    <div class="modal-dialog" style="width:750px;">
	    <div class="modal-content">
		    <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Edit User KDR Non Aktif</h4>
		    </div>
		    <form class="form-horizontal" action="<?php echo base_url().'kdr/manajemen_user_kdr'?>" method="post">
		        <div class="modal-body">
		            <div class="form-group">
    ...
    <div class="modal-dialog">
	    <div class="modal-content">
		    <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Konfirmasi Hapus Data User KDR Non Aktif</h4>
		    </div>
		    <div class="modal-body">
		    	<form class="form-horizontal" action="<?php echo base_url().'kdr/manajemen_user_kdr'?>" method="post">
			        <div class="modal-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Tambahkan User KDR Baru</h4>
            </div>
            <form class="form-horizontal" action="<?php echo base_url('kdr/manajemen_user_kdr'); ?>" method="post">
                <div class="modal-body">
                	<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="dropdown" name="level" required style="width: 100%;">
                            	...
                            	<option class="option" value="kabagkdr">Kabag KDR</option>
