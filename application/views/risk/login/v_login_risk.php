...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Login Page - Risk Profile</title>

		<meta name="description" content="Login Page - Risk Profile"/>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="black" id="id-text2">RISK</span>
								</h1>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="<?php echo base_url('risk/login_risk'); ?>" method="post" class="form-signin">
												<fieldset>
								...
								<div id="signup-box" class="signup-box widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="<?php echo base_url('risk/login_risk/check'); ?>" method="POST" parsley-validate>
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
