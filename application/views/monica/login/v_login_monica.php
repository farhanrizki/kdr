						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="black" id="id-text2">MONICA</span>
								</h1>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="<?php echo base_url('monica/login_monica'); ?>" method="post" class="form-signin">
												<fieldset>
								...
								<div id="signup-box" class="signup-box widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="<?php echo base_url('monica/login_monica/check'); ?>" method="POST" parsley-validate>
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
