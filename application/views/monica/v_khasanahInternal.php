	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Khasanah Internal</li>
			</ul>
		</div>
			...
			<div class="row">
	            <div class="col-xs-12">
	                <div class="box box-primary">
	                    <div class="col-xs-12">	
	                        <button data-target="#tambahkhasanah" data-toggle="modal" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Khasanah Internal </button>
	                        <hr>
	                    </div>
	                    <div class="box-body">
	                        <table id="tabel" class="table table-bordered table-striped">
                                ...
                                <?php 
                                	$no = 1;
									foreach($data_khasanah_internal as $row)
									{ 
								...
								?>
									<tr class="baris">
										...
										<td align="center">
											<?php if ($row['file'] != '') { ?>
												<a href="<?php echo base_url().'upload/compliance/internal/'.$row['file']; ?>" class="dwn" target="_blank"><?php echo $row['file']; ?></a>
											<?php } else { 
												echo "-";
											} ?>
										</td>
										...
										<td align="center">
											<button type="button" class="view_data btn btn-primary btn-xs" 
											onclick="window.location='<?php echo base_url("monica/khasanah_internal/edit_khasanah_internal/".$row['id_compliance']);?>'"><i class="ace-icon fa fa-edit"></i></button>
											&nbsp;
											<button type="button" class="view_data btn btn-primary btn-xs" 
    ...
    <div class="modal-dialog">
	    <div class="modal-content">
		    <div class="modal-header">
                ...
                <h4 class="modal-title">Konfirmasi Hapus Data Khasanah Internal</h4>
		    </div>
		    <div class="modal-body">
		    	<form class="form-horizontal" action="<?php echo base_url().'monica/khasanah_internal'?>" method="post">
			        <div class="modal-body">
			        ...
			        <div class="modal-footer">
			        	<button type="submit" name="hapuskhasanahinternal" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i>Ya</button>
	...
	<div class="modal-dialog" role="document" style="width:1000px;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Data Khasanah Internal</h4>
				<div class="modal-body">
    ...
    <div class="modal-dialog" style="width:1000px;">
	    <div class="modal-content">
		    <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Tambah Data Khasanah Internal</h4>
		    </div>
		    <form class="form-horizontal" action="<?php echo base_url().'monica/khasanah_internal'?>" method="post" enctype="multipart/form-data">
		        <div class="modal-body">
		            <div class="form-group">
                        ...
                        <div class="form-group">
						    <div class="col-sm-2">
						    	<select id="no_doc" name="nomor_doc" class="form-control" required>
									...
									<option value="CP-INT">CP-INT</option>
									<option value="BA-INT">BA-INT</option>
									<option value="PD-INT">PD-INT</option>
								</select>
						    </div>
						    <div class="col-sm-1">
		        ...
		        <div class="modal-footer">
		            <button type="submit" name="tambahkhasanahinternal" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Tambah Khasanah</button>
...
<!-- Tampil detail khasanah internal -->
<script>
	function LihatData(id_compliance) 
	{
		...
		$.ajax({
			method: 'POST',
			url: "<?php echo base_url('monica/khasanah_internal/detail_khasanah_internal/'); ?>",
...
<script>
	$('#no_doc').on('change', function() 
	{
	    ...
	    $.ajax({
	        type: "POST",
	        url: "<?php echo base_url('monica/khasanah_internal/doc_int_input/'); ?>",
...
<!-- Untuk menghitung selisih hari deadline
