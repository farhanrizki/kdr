	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li>
					<a href="<?php echo base_url('monica/khasanah_internal'); ?>">Khasanah Internal</a>
				</li>
				<li class="active">Edit Khasanah Internal</li>
			</ul>
		</div>
								...
								<div class="row">
									<div class="col-md-6 col-md-offset-3">
										<div class="well well-sm">
											<form class="form-horizontal" action="<?php echo base_url().'monica/khasanah_internal/update_khasanah_internal'?>" method="post" 
												enctype="multipart/form-data">
												<fieldset>
												<?php foreach($lihat_internal as $row) { 
													...
													$file           = $row['file'];
												?>
													<legend class="text-center">Form Edit Khasanah Internal</legend>
													<div class="form-group">
														...
														<div class="col-md-4">
															<select class="form-control" id="no_doc" name="no_doc" required>
																...
																<option value="CP-INT" <?php if(substr($nomor_doc,0,6)=="CP-INT") echo 'selected="selected"'; ?>>CP-INT</option>
																<option value="BA-INT" <?php if(substr($nomor_doc,0,6)=="BA-INT") echo 'selected="selected"'; ?>>BA-INT</option>
																<option value="PD-INT" <?php if(substr($nomor_doc,0,6)=="PD-INT") echo 'selected="selected"'; ?>>PD-INT</option>
															</select>
														</div>
														<div class="col-sm-2">
													...
													<div class="form-group">
														...
														<div class="col-md-9">
								                            ...
								                            <span>
								                            	<a href="<?php echo base_url().'upload/compliance/internal/'.$file; ?>" class="dwn" target="_blank">
								                            		<?php echo $file; ?>
								                            	</a>
								                            </span>
...
<script>
	$('#no_doc').on('change', function() 
	{
	    ...
	    $.ajax({
	        type: "POST",
	        url: "<?php echo base_url('monica/khasanah_internal/doc_int_edit/'); ?>",
