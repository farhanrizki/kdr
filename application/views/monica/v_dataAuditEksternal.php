	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Data Audit Eksternal</li>
			</ul>
		</div>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
		            ...
		            <div class="col-xs-3"> 
		                <button type="button" data-target="#tambahaudit" data-toggle="modal" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Audit Eksternal </button>
		            </div>
		           	<?php } ?>
			        		...
			        		<div id="signupbox" class="mainbox col-md-4">
			                    <div class="panel panel-info">
			                        <div class="panel-body">
			                        	<form method="post" action="<?php echo base_url().'monica/data_audit_eksternal'?>">
			                                <div class="form-group">
			                                    ...
			                                    <div class="col-sm-8">
			                                        <select name="tahun" class="chosen-select form-control" id="form-field-select-3">
			                                            ...
			                                            <?php foreach($tahun_audit_eksternal as $row) { ?>
	                            ...
	                            <div class="infobox infobox-black">
									...
									<div class="infobox-data">
										...
										<div class="infobox-content">
											...
											?>
											<a href="<?php echo site_url('monica/data_audit_eksternal/download_audit_eksternal/'.$tah.'/'.$nama_bagian.'/'.$sta); ?>">Download</a>
										</div>
									</div>
								</div>
			                </div> 
	                ...
	                <div class="box box-primary">
	                    ...
	                    <div class="box-body">
	                        <table id="tabel" class="table table-bordered table-striped">
	                            ...
	                            <tbody>
                                <?php $no = 1; $today = date("Y-m-d"); foreach($data_audit_eksternal as $row){ ?>
									<tr class="baris">
										<td><?=$no++?></td>
										...
										<td align="center">
											<?php if ($row['upload'] != '') { ?>
												<a href="<?php echo base_url().'upload/audit/eksternal/'.$row['upload']; ?>" class="dwn" target="_blank"><?php echo $row['upload']; ?></a>
											<?php } else { 
												echo "-";
											} ?>
										</td>
...
<?php 
    foreach($data_audit_eksternal as $row):
    ...
    <div class="modal-dialog" style="width:1000px;">
	    <div class="modal-content">
		    <div class="modal-header">
                ...
                <h4 class="modal-title">Edit Audit Eksternal</h4>
		    </div>
		    <form class="form-horizontal" action="<?php echo base_url().'monica/data_audit_eksternal'?>" method="post" enctype="multipart/form-data">
		        <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Regulator</label>
                        <div class="col-sm-10">
                            <select name="regulator[<?=$row['id_audit']?>]" id="regulator" class="chosen-select form-control" id="form-field-select-3" required>
                            	<option value="BI" <?php if($row['regulator'] == 'BI'){ echo 'selected';} ?>>BI</option>
                            	<option value="OJK" <?php if($row['regulator'] == 'OJK'){ echo 'selected';} ?>>OJK</option>
                            	<option value="BPK" <?php if($row['regulator'] == 'BPK'){ echo 'selected';} ?>>BPK</option>
                            	<option value="EY" <?php if($row['regulator'] == 'EY'){ echo 'selected';} ?>>EY</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span>
                            	<a href="<?php echo base_url().'upload/audit/eksternal/'.$row['upload']; ?>" class="dwn" target="_blank">
                            		<?php echo $row['upload']; ?>
                            	</a>
                            </span>
		        ...
		        <div class="modal-footer">
		            <button type="submit" name="updateauditeksternal" class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"></i>Update</button>
    ...
    <div class="modal-dialog">
	    <div class="modal-content">
		    <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Konfirmasi Hapus Data Audit Eksternal</h4>
		    </div>
		    <div class="modal-body">
		    	<form class="form-horizontal" action="<?php echo base_url().'monica/data_audit_eksternal'?>" method="post">
			        <div class="modal-body">
			            <div class="form-group">
			        ...
			        <div class="modal-footer">
			        	<button type="submit" name="hapusauditeksternal" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i>Ya</button>
	...
	<div class="modal-dialog" role="document" style="width:1300px;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Data Audit Eksternal</h4>
				<div class="modal-body">
...
<!-- Modal Tambah Audit Eksternal -->
<div id="tambahaudit" class="modal fade" role="dialog">
    <div class="modal-dialog" style="width:1000px;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Tambahkan Audit Eksternal Baru</h4>
            </div>
            <form class="form-horizontal" action="<?php echo base_url('monica/data_audit_eksternal'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Regulator</label>
                        <div class="col-sm-10">
                            <select name="regulator" class="chosen-select form-control" id="form-field-select-3" required>
                                <option class="option" value="">Pilih Regulator</option>
                                <option class="option" value="BI">BI</option>
                                <option class="option" value="OJK">OJK</option>
                                <option class="option" value="BPK">BPK</option>
                                <option class="option" value="EY">EY</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="submit" name="tambahauditeksternal" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>
                    Tambah Audit</button>
...
<script>
	function LihatData(id_audit) 
	{
		...
		$.ajax({
			method: 'POST',
			url: "<?php echo base_url('monica/data_audit_eksternal/detail_audit_eksternal/'); ?>",
